...
const JoinOurCommunity: React.FC = () => {
    return (
        <section aria-label="Join our community" className="w-full md:py-36 py-28 px-4">
            <div className='w-full max-w-[80%] mx-auto flex flex-col justify-center items-center gap-6'>
                <div className='w-full flex lg:flex-row items-center flex-col gap-4'>
                    <h2 className="flex-1 text-[#F0F7F7] font-orbitron md:text-[36px] text-[28px] -tracking-[2%] font-[700]">Join Our Community</h2>
                ...
                <div className="w-full flex md:flex-row flex-col gap-4 md:gap-0 justify-center md:items-center items-start mt-2">
                    ...
                    <a
                        ...
                        className="relative group w-[227px] h-[40px] flex items-center justify-center overflow-hidden cursor-pointer"
                    >
                        <svg
                            width="227"
                            height="40"
                        ...
                        <span className="relative z-10 flex items-center text-[#0FF0FC] capitalize text-[13px] font-dmSans font-medium">
                    ...
                    >
                        ...
                        <span className="relative z-10 flex items-center text-[#00F0FF] capitalize text-[13px] font-dmSans font-medium">
